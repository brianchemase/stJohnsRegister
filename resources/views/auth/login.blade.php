...
<html lang="en">
  <head>
    ...
    <title>STJAK College Login</title>
  </head>
  <body>
            ...
            <div class="form-block mx-auto">
              <div class="text-center mb-5">
                    <div class="text-center">
						        <img src="logo/StJohnCollegeLogo-03.png" alt="Logo" class="img-fluid" width="132" height="132" data-tilt />
					  </div>
                    <br>
              <h3>Login to <strong>Training Portal</strong></h3>
              ...
              <form action="{{ route('login') }}" method="post">
                ...
                <div class="form-group first">
                  ...
                  <input type="text" class="form-control" placeholder="Key in your registered email" name="email" value="{{ old('email') }}" id="username" required>
                             @error('email')
